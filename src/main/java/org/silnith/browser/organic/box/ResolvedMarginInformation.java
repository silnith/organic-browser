...
public class ResolvedMarginInformation {
	...
	public ResolvedMarginInformation(final AbsoluteLength marginTop, final AbsoluteLength marginRight, final AbsoluteLength marginBottom, final AbsoluteLength marginLeft) {
		super();
