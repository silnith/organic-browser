...
public class CSSPseudoElementRule {
	...
	public CSSPseudoElementRule(final String elementName, final String beforeString,
	...
	public CSSPseudoElementRule(final String elementName, final String beforeString,
			final String afterString, final List<CSSRule> beforeRules, final List<CSSRule> afterRules) {
	...
	public String toString() {
		return "CSSPseudoElementRule {before: " + beforeString + ", after: " + afterString + ", before rules: " + beforeRules + ", after rules: " + afterRules + "}";
	}
