...
/**
 * [84]   	Letter	   ::=   	{@linkplain BaseCharProduction BaseChar} | {@linkplain IdeographicProduction Ideographic} 
 * 
...
public class LetterProduction extends XMLProduction {
	...
	public LetterProduction(final Grammar<UnicodeTerminalSymbols> grammar,
			final BaseCharProduction baseCharProduction,
