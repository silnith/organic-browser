...
/**
 * [31] extSubsetDecl ::= ( {@linkplain MarkupDeclProduction markupdecl} |
 * {@linkplain ConditionalSectProduction conditionalSect} |
 * {@linkplain DeclSepProduction DeclSep})*
 * 
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-extSubsetDecl">
 *      extSubsetDecl</a>
...
public class ExtSubsetDeclProduction extends XMLProduction {
    ...
    public ExtSubsetDeclProduction(final Grammar<UnicodeTerminalSymbols> grammar,
            final MarkupDeclProduction markupDeclProduction, final ConditionalSectProduction conditionalSectProduction,
        ...
        final NonTerminalSymbol extSubsetDecl_inner_Plus =
                this.grammar.getNonTerminalSymbol("extSubsetDecl-inner-Plus");
