...
/**
 * [41]   	Attribute	   ::=   	{@linkplain NameProduction Name} {@linkplain EqProduction Eq} {@linkplain AttValueProduction AttValue} 
 * 
...
public class AttributeProduction extends XMLProduction {
	...
	public AttributeProduction(final Grammar<UnicodeTerminalSymbols> grammar,
			final NameProduction nameProduction, final EqProduction eqProduction,
			final AttValueProduction attValueProduction, final SProduction sProduction) {
		super(grammar);
		...
		this.grammar.addProduction(AttributeList_Plus, new AppendAttributeListHandler(), AttributeList_Plus, S, Attribute);
