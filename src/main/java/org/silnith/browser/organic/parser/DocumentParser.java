...
//	private static final String HTML_NAMESPACE = "http://www.w3.org/1999/xhtml";
	...
	public DocumentParser() throws ClassNotFoundException, InstantiationException, IllegalAccessException, ClassCastException {
		super();
...
//		return parseDocument(inputStream, download.getContentEncoding());
	...
	public Document parseDocument(final InputStream inputStream, final String encoding) {
		 ...
		 * 
		 * For XML DTD, set second parameter to createLSParser to
...
//			badgerPara.appendChild(domDocument.createTextNode(""));
		...
		nestedElementsPara.appendChild(domDocument.createTextNode("This is two inline elements nested inside each other: "));
