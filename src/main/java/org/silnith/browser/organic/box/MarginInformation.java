...
public class MarginInformation {
	...
	private static final PropertyAccessor<Length<?>> marginTopAccessor = (PropertyAccessor<Length<?>>) propertyAccessorFactory.getPropertyAccessor(PropertyName.MARGIN_TOP);
	private static final PropertyAccessor<Length<?>> marginRightAccessor = (PropertyAccessor<Length<?>>) propertyAccessorFactory.getPropertyAccessor(PropertyName.MARGIN_RIGHT);
	private static final PropertyAccessor<Length<?>> marginBottomAccessor = (PropertyAccessor<Length<?>>) propertyAccessorFactory.getPropertyAccessor(PropertyName.MARGIN_BOTTOM);
	private static final PropertyAccessor<Length<?>> marginLeftAccessor = (PropertyAccessor<Length<?>>) propertyAccessorFactory.getPropertyAccessor(PropertyName.MARGIN_LEFT);
	...
	public MarginInformation(final Length<?> marginTop, final Length<?> marginRight, final Length<?> marginBottom, final Length<?> marginLeft) {
		super();
