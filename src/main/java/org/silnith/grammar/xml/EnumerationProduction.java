...
/**
 * [59] Enumeration ::= '(' {@linkplain SProduction S}?
 ...
 * 
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-Enumeration">
 *      Enumeration</a>
...
public class EnumerationProduction extends XMLProduction {
    ...
    public EnumerationProduction(final Grammar<UnicodeTerminalSymbols> grammar, final SProduction sProduction,
        ...
        this.grammar.addProduction(Enumeration, nullHandler, leftParenthesis, S, Nmtoken, S, Enumeration_inner_Plus,
                rightParenthesis);
        this.grammar.addProduction(Enumeration, nullHandler, leftParenthesis, Nmtoken, S, Enumeration_inner_Plus,
                rightParenthesis);
        this.grammar.addProduction(Enumeration, nullHandler, leftParenthesis, S, Nmtoken, Enumeration_inner_Plus,
                rightParenthesis);
        this.grammar.addProduction(Enumeration, nullHandler, leftParenthesis, Nmtoken, Enumeration_inner_Plus,
                rightParenthesis);
