...
/**
 * [54]   	AttType	   ::=   	{@linkplain StringTypeProduction StringType} | {@linkplain TokenizedTypeProduction TokenizedType} | {@linkplain EnumeratedTypeProduction EnumeratedType} 
 * 
...
public class AttTypeProduction extends XMLProduction {
	...
	public AttTypeProduction(final Grammar<UnicodeTerminalSymbols> grammar,
			final StringTypeProduction stringTypeProduction,
			final TokenizedTypeProduction tokenizedTypeProduction,
