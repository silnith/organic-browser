...
/**
 * [64] ignoreSectContents ::= {@linkplain IgnoreSectContentsProduction Ignore}
 * ('&lt;![' {@linkplain IgnoreSectContentsProduction ignoreSectContents}
 * ']]&gt;' {@linkplain IgnoreSectContentsProduction Ignore})* [65] Ignore ::=
 ...
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-Ignore">Ignore
 *      </a>
...
public class IgnoreSectContentsProduction extends XMLProduction {
    ...
    public IgnoreSectContentsProduction(final Grammar<UnicodeTerminalSymbols> grammar) {
        ...
        final NonTerminalSymbol ignoreSectContents_inner_Plus =
                this.grammar.getNonTerminalSymbol("ignoreSectContents-inner-Plus");
        ...
        this.grammar.addProduction(ignoreSectContents_inner_Plus, nullHandler, lessThanSign, exclamationMark,
                leftBracket, ignoreSectContents, rightBracket, rightBracket, greaterThanSign, Ignore,
                ignoreSectContents_inner_Plus);
        this.grammar.addProduction(ignoreSectContents_inner_Plus, nullHandler, lessThanSign, exclamationMark,
                leftBracket, ignoreSectContents, rightBracket, rightBracket, greaterThanSign, Ignore);
