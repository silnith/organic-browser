...
/**
 * @see <a href=
 *      "http://www.whatwg.org/specs/web-apps/current-work/multipage/tokenization.html#script-data-escaped-end-tag-name-state">
 *      12.2.4.27 Script data escaped end tag name state</a>
