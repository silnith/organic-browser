...
/**
 * [47] children ::= ({@linkplain ChildrenProduction choice} |
 * {@linkplain ChildrenProduction seq}) ('?' | '*' | '+')? [48] cp ::= (
 * {@linkplain NameProduction Name} | {@linkplain ChildrenProduction choice} |
 * {@linkplain ChildrenProduction seq}) ('?' | '*' | '+')? [49] choice ::= '('
 * {@linkplain SProduction S}? {@linkplain ChildrenProduction cp} (
 * {@linkplain SProduction S}? '|' {@linkplain SProduction S}?
 * {@linkplain ChildrenProduction cp} )+ {@linkplain SProduction S}? ')' [50]
 * seq ::= '(' {@linkplain SProduction S}? {@linkplain ChildrenProduction cp} (
 * {@linkplain SProduction S}? ',' {@linkplain SProduction S}?
 ...
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-choice">choice
 *      </a>
...
public class ChildrenProduction extends XMLProduction {
    ...
    public ChildrenProduction(final Grammar<UnicodeTerminalSymbols> grammar, final SProduction sProduction,
