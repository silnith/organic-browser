...
/**
 * [1] document ::= {@linkplain PrologProduction prolog}
 * {@linkplain ElementProduction element} {@linkplain MiscProduction Misc}*
 * 
...
public class DocumentProduction extends XMLProduction {
    ...
    private static List<Misc> getMiscList(final List<Object> list) {
        ...
        for (final Object obj : list) {
            if (obj instanceof List<?>) {
                final List<Misc> o = (List<Misc>) obj;
                miscList.addAll(o);
    ...
    public DocumentProduction(final Grammar<UnicodeTerminalSymbols> grammar, final XMLDeclProduction xmlDeclProduction,
            final MiscProduction miscProduction, final SProduction sProduction,
            final DoctypedeclProduction doctypedeclProduction, final ElementProduction elementProduction) {
        super(grammar);
