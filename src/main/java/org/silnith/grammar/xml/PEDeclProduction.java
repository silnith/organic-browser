...
/**
 * [72]   	PEDecl	   ::=   	'&lt;!ENTITY' {@linkplain SProduction S} '%' {@linkplain SProduction S} {@linkplain NameProduction Name} {@linkplain SProduction S} {@linkplain PEDefProduction PEDef} {@linkplain SProduction S}? '&gt;'
 * 
...
public class PEDeclProduction extends XMLProduction {
	...
	public PEDeclProduction(final Grammar<UnicodeTerminalSymbols> grammar,
			final SProduction sProduction, final NameProduction nameProduction,
			final PEDefProduction peDefProduction) {
		super(grammar);
		...
		this.grammar.addProduction(PEDecl, nullHandler, lessThanSign, exclamationMark, capitalE, capitalN, capitalT, capitalI, capitalT, capitalY, S, percentSign, S, Name, S, PEDef, S, greaterThanSign);
		this.grammar.addProduction(PEDecl, nullHandler, lessThanSign, exclamationMark, capitalE, capitalN, capitalT, capitalI, capitalT, capitalY, S, percentSign, S, Name, S, PEDef, greaterThanSign);
	}
