...
public class BorderLeftColorAccessor extends
		PropertyThatDependsOnTheColorPropertyAccessor {

	public BorderLeftColorAccessor(final ColorParser colorParser,
			final PropertyAccessor<Color> colorPropertyAccessor) {
		super(PropertyName.BORDER_LEFT_COLOR, colorParser,
