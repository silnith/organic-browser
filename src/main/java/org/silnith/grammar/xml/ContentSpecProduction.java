...
/**
 * [46]   	contentspec	   ::=   	'EMPTY' | 'ANY' | {@linkplain MixedProduction Mixed} | {@linkplain ChildrenProduction children} 
 * 
...
public class ContentSpecProduction extends XMLProduction {
	...
	public ContentSpecProduction(final Grammar<UnicodeTerminalSymbols> grammar,
			final MixedProduction mixedProduction,
