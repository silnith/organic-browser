...
public abstract class PropertyThatDependsOnTheColorPropertyAccessor extends PropertyAccessor<Color> {
	...
	public PropertyThatDependsOnTheColorPropertyAccessor(final PropertyName propertyName, final ColorParser colorParser, final PropertyAccessor<Color> colorPropertyAccessor) {
