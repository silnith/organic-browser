...
/**
 * [60] DefaultDecl ::= '#REQUIRED' | '#IMPLIED' | (('#FIXED'
 * {@linkplain SProduction S})? {@linkplain AttValueProduction AttValue})
 * 
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-DefaultDecl">
 *      DefaultDecl</a>
...
public class DefaultDeclProduction extends XMLProduction {
    ...
    public DefaultDeclProduction(final Grammar<UnicodeTerminalSymbols> grammar, final SProduction sProduction,
            final AttValueProduction attValueProduction) {
        super(grammar);
        ...
        this.grammar.addProduction(DefaultDecl, nullHandler, numberSign, capitalR, capitalE, capitalQ, capitalU,
                capitalI, capitalR, capitalE, capitalD);
        this.grammar.addProduction(DefaultDecl, nullHandler, numberSign, capitalI, capitalM, capitalP, capitalL,
                capitalI, capitalE, capitalD);
        this.grammar.addProduction(DefaultDecl, nullHandler, numberSign, capitalF, capitalI, capitalX, capitalE,
                capitalD, S, AttValue);
