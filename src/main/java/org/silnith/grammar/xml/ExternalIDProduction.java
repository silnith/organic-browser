...
/**
 * [75] ExternalID ::= 'SYSTEM' {@linkplain SProduction S}
 * {@linkplain SystemLiteralProduction SystemLiteral} | 'PUBLIC'
...
public class ExternalIDProduction extends XMLProduction {
    ...
    public ExternalIDProduction(final Grammar<UnicodeTerminalSymbols> grammar,
            final PublicIDProduction publicIDProduction, final SProduction sProduction,
        ...
        this.grammar.addProduction(ExternalID, nullHandler, capitalS, capitalY, capitalS, capitalT, capitalE, capitalM,
                S, SystemLiteral);
    }
