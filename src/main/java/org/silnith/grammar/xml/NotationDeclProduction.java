...
/**
 * [82]   	NotationDecl	   ::=   	'&lt;!NOTATION' {@linkplain SProduction S} {@linkplain NameProduction Name} {@linkplain SProduction S} ({@linkplain ExternalIDProduction ExternalID} | {@linkplain PublicIDProduction PublicID}) {@linkplain SProduction S}? '&gt;'
 * 
...
public class NotationDeclProduction extends XMLProduction {
	...
	public NotationDeclProduction(final Grammar<UnicodeTerminalSymbols> grammar,
		...
		this.grammar.addProduction(NotationDecl, nullHandler, lessThanSign, exclamationMark, capitalN, capitalO, capitalT, capitalA, capitalT, capitalI, capitalO, capitalN, S, Name, S, ExternalID, S, greaterThanSign);
		this.grammar.addProduction(NotationDecl, nullHandler, lessThanSign, exclamationMark, capitalN, capitalO, capitalT, capitalA, capitalT, capitalI, capitalO, capitalN, S, Name, S, ExternalID, greaterThanSign);
		this.grammar.addProduction(NotationDecl, nullHandler, lessThanSign, exclamationMark, capitalN, capitalO, capitalT, capitalA, capitalT, capitalI, capitalO, capitalN, S, Name, S, PublicID, S, greaterThanSign);
		this.grammar.addProduction(NotationDecl, nullHandler, lessThanSign, exclamationMark, capitalN, capitalO, capitalT, capitalA, capitalT, capitalI, capitalO, capitalN, S, Name, S, PublicID, greaterThanSign);
	}
