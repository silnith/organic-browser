...
/**
 * [77] TextDecl ::= '&lt;?xml' {@linkplain VersionInfoProduction VersionInfo}?
...
public class TextDeclProduction extends XMLProduction {
    ...
    public TextDeclProduction(final Grammar<UnicodeTerminalSymbols> grammar,
        ...
        this.grammar.addProduction(TextDecl, nullHandler, lessThanSign, questionMark, smallX, smallM, smallL,
        ...
        this.grammar.addProduction(TextDecl, nullHandler, lessThanSign, questionMark, smallX, smallM, smallL, S,
