...
/**
 * [32] SDDecl ::= {@linkplain SProduction S} 'standalone'
 * {@linkplain EqProduction Eq} (("'" ('yes' | 'no') "'") | ('
 * "' ('yes' | 'no') '"'))
 * 
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-SDDecl">SDDecl
 *      </a>
...
public class SDDeclProduction extends XMLProduction {
    ...
    public SDDeclProduction(final Grammar<UnicodeTerminalSymbols> grammar, final SProduction sProduction,
            final EqProduction eqProduction) {
        super(grammar);
        ...
        this.grammar.addProduction(SDDecl, yesHandler, S, smallS, smallT, smallA, smallN, smallD, smallA, smallL,
                smallO, smallN, smallE, Eq, apostrophe, smallY, smallE, smallS, apostrophe);
        this.grammar.addProduction(SDDecl, noHandler, S, smallS, smallT, smallA, smallN, smallD, smallA, smallL, smallO,
                smallN, smallE, Eq, apostrophe, smallN, smallO, apostrophe);
        this.grammar.addProduction(SDDecl, yesHandler, S, smallS, smallT, smallA, smallN, smallD, smallA, smallL,
                smallO, smallN, smallE, Eq, quotationMark, smallY, smallE, smallS, quotationMark);
        this.grammar.addProduction(SDDecl, noHandler, S, smallS, smallT, smallA, smallN, smallD, smallA, smallL, smallO,
                smallN, smallE, Eq, quotationMark, smallN, smallO, quotationMark);
    }
