...
public class OrphansAccessor extends PropertyAccessor<Integer> {
    
    public OrphansAccessor() {
        super(PropertyName.ORPHANS, true);
    }
    ...
    protected Integer parse(StyleData styleData, List<Token> specifiedValue) throws IOException {
        ...
        case LEXICAL_TOKEN: {
            ...
            case NUMBER_TOKEN: {
                ...
                case NUMBER: {
                    throw new IllegalArgumentException("Orphans must be an integer.");
                } // break;
                default: break;
                }
            } break;
