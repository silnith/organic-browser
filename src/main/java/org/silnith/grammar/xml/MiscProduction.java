...
/**
 * [27] Misc ::= {@linkplain CommentProduction Comment} |
 * {@linkplain PIProduction PI} | {@linkplain SProduction S}
 * 
...
public class MiscProduction extends XMLProduction {
    ...
    public MiscProduction(final Grammar<UnicodeTerminalSymbols> grammar, final SProduction sProduction,
            final CommentProduction commentProduction, final PIProduction piProduction) {
        super(grammar);
