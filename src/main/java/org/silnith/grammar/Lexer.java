...
public class Lexer implements Iterable<UnicodeTerminalSymbols> {
	...
	private class UnicodeLexerIterator implements Iterator<UnicodeTerminalSymbols> {
		...
		public UnicodeTerminalSymbols next() {
			...
			case UnicodeCodePoints.CHARACTER_TABULATION: { symbol = UnicodeTerminalSymbols.tab; } break;
			case UnicodeCodePoints.LINE_FEED: { symbol = UnicodeTerminalSymbols.lineFeed; } break;
			case UnicodeCodePoints.CARRIAGE_RETURN: { symbol = UnicodeTerminalSymbols.carriageReturn; } break;
			case UnicodeCodePoints.SPACE: { symbol = UnicodeTerminalSymbols.space; } break;
			case UnicodeCodePoints.EXCLAMATION_MARK: { symbol = UnicodeTerminalSymbols.exclamationMark; } break;
			case UnicodeCodePoints.QUOTATION_MARK: { symbol = UnicodeTerminalSymbols.quotationMark; } break;
			case UnicodeCodePoints.NUMBER_SIGN: { symbol = UnicodeTerminalSymbols.numberSign; } break;
			case UnicodeCodePoints.DOLLAR_SIGN: { symbol = UnicodeTerminalSymbols.dollarSign; } break;
			case UnicodeCodePoints.PERCENTAGE_SIGN: { symbol = UnicodeTerminalSymbols.percentSign; } break;
			case UnicodeCodePoints.AMPERSAND: { symbol = UnicodeTerminalSymbols.ampersand; } break;
			case UnicodeCodePoints.APOSTROPHE: { symbol = UnicodeTerminalSymbols.apostrophe; } break;
			case UnicodeCodePoints.LEFT_PARENTHESIS: { symbol = UnicodeTerminalSymbols.leftParenthesis; } break;
			case UnicodeCodePoints.RIGHT_PARENTHESIS: { symbol = UnicodeTerminalSymbols.rightParenthesis; } break;
			case UnicodeCodePoints.ASTERISK: { symbol = UnicodeTerminalSymbols.asterisk; } break;
			case UnicodeCodePoints.PLUS_SIGN: { symbol = UnicodeTerminalSymbols.plusSign; } break;
			case UnicodeCodePoints.COMMA: { symbol = UnicodeTerminalSymbols.comma; } break;
			case UnicodeCodePoints.HYPHEN_MINUS: { symbol = UnicodeTerminalSymbols.hyphenMinus; } break;
			case UnicodeCodePoints.FULL_STOP: { symbol = UnicodeTerminalSymbols.fullStop; } break;
			case UnicodeCodePoints.SOLIDUS: { symbol = UnicodeTerminalSymbols.solidus; } break;
			case UnicodeCodePoints.DIGIT_ZERO: { symbol = UnicodeTerminalSymbols.digitZero; } break;
			...
			case UnicodeCodePoints.DIGIT_NINE: { symbol = UnicodeTerminalSymbols.digitNine; } break;
			case UnicodeCodePoints.COLON: { symbol = UnicodeTerminalSymbols.colon; } break;
			case UnicodeCodePoints.SEMICOLON: { symbol = UnicodeTerminalSymbols.semicolon; } break;
			case UnicodeCodePoints.LESS_THAN_SIGN: { symbol = UnicodeTerminalSymbols.lessThanSign; } break;
			case UnicodeCodePoints.EQUALS_SIGN: { symbol = UnicodeTerminalSymbols.equalsSign; } break;
			case UnicodeCodePoints.GREATER_THAN_SIGN: { symbol = UnicodeTerminalSymbols.greaterThanSign; } break;
			case UnicodeCodePoints.QUESTION_MARK: { symbol = UnicodeTerminalSymbols.questionMark; } break;
			case UnicodeCodePoints.COMMERCIAL_AT: { symbol = UnicodeTerminalSymbols.atSymbol; } break;
			case UnicodeCodePoints.LATIN_CAPITAL_LETTER_A: { symbol = UnicodeTerminalSymbols.capitalA; } break;
			...
			case UnicodeCodePoints.LATIN_CAPITAL_LETTER_Z: { symbol = UnicodeTerminalSymbols.capitalZ; } break;
			case UnicodeCodePoints.LEFT_SQUARE_BRACKET: { symbol = UnicodeTerminalSymbols.leftBracket; } break;
			case UnicodeCodePoints.REVERSE_SOLIDUS: { symbol = UnicodeTerminalSymbols.reverseSolidus; } break;
			case UnicodeCodePoints.RIGHT_SQUARE_BRACKET: { symbol = UnicodeTerminalSymbols.rightBracket; } break;
			case UnicodeCodePoints.CIRCUMFLEX_ACCENT: { symbol = UnicodeTerminalSymbols.circumflexAccent; } break;
			case UnicodeCodePoints.LOW_LINE: { symbol = UnicodeTerminalSymbols.lowLine; } break;
			case UnicodeCodePoints.GRAVE_ACCENT: { symbol = UnicodeTerminalSymbols.graveAccent; } break;
			case UnicodeCodePoints.LATIN_SMALL_LETTER_A: { symbol = UnicodeTerminalSymbols.smallA; } break;
			...
			case UnicodeCodePoints.LATIN_SMALL_LETTER_Z: { symbol = UnicodeTerminalSymbols.smallZ; } break;
			case UnicodeCodePoints.LEFT_CURLY_BRACKET: { symbol = UnicodeTerminalSymbols.leftCurlyBrace; } break;
			case UnicodeCodePoints.VERTICAL_LINE: { symbol = UnicodeTerminalSymbols.verticalBar; } break;
			case UnicodeCodePoints.RIGHT_CURLY_BRACKET: { symbol = UnicodeTerminalSymbols.rightCurlyBrace; } break;
			case UnicodeCodePoints.TILDE: { symbol = UnicodeTerminalSymbols.tilde; } break;
			case UnicodeCodePoints.DELETE: { symbol = UnicodeTerminalSymbols.delete; } break;
			default: {
