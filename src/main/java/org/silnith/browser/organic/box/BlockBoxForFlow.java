...
//			final RelativeLength relativeLength = (RelativeLength) length;
    ...
    public AbsoluteLength negotiateWidth(final AbsoluteLength containingBlockWidth, final AbsoluteLength targetWidth,
        ...
        final AbsoluteLength childNegotiatedWidth = inlineFormattingContextImpl.negotiateWidth(
                childContainingBlockWidth, childContainingBlockWidth, graphics);
    ...
    public synchronized RenderableContent layoutContents(final AbsoluteLength containingBlockWidth,
        ...
        final RenderableContent renderableContent =
                inlineFormattingContextImpl.layoutContents(containingBlockWidth, childTargetWidth, graphics);
         ...
         */
        final RenderedBox box = new RenderedBox(paddingLeft + (float) renderableSize.getWidth() + paddingRight,
                paddingTop + (float) renderableSize.getHeight() + paddingBottom, borderInformation);
