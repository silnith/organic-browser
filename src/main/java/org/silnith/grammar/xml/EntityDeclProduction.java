...
/**
 * [70] EntityDecl ::= {@linkplain GEDeclProduction GEDecl} |
 * {@linkplain PEDeclProduction PEDecl}
 * 
...
public class EntityDeclProduction extends XMLProduction {
    ...
    public EntityDeclProduction(final Grammar<UnicodeTerminalSymbols> grammar, final GEDeclProduction geDeclProduction,
