...
/**
 * [16]   	PI	   ::=   	'&lt;?' {@linkplain PITargetProduction PITarget} ({@linkplain SProduction S} ({@linkplain CharProduction Char}* - ({@linkplain CharProduction Char}* '?&gt;' {@linkplain CharProduction Char}*)))? '?&gt;'
 * 
...
public class PIProduction extends XMLProduction {
	...
	public PIProduction(final Grammar<UnicodeTerminalSymbols> grammar,
			final PITargetProduction piTargetProduction,
		...
		this.grammar.addProduction(PI, piHandler, lessThanSign, questionMark, PITarget, S, PI_inner, questionMark, greaterThanSign);
		this.grammar.addProduction(PI, emptyPIHandler, lessThanSign, questionMark, PITarget, S, questionMark, greaterThanSign);
		this.grammar.addProduction(PI, emptyPIHandler, lessThanSign, questionMark, PITarget, questionMark, greaterThanSign);
