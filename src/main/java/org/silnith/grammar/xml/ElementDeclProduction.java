...
/**
 * [45]   	elementdecl	   ::=   	'&lt;!ELEMENT' {@linkplain SProduction S} {@linkplain NameProduction Name} {@linkplain SProduction S} {@linkplain ContentSpecProduction contentspec} {@linkplain SProduction S}? '&gt;'
 * 
...
public class ElementDeclProduction extends XMLProduction {
	...
	public ElementDeclProduction(final Grammar<UnicodeTerminalSymbols> grammar,
		...
		this.grammar.addProduction(elementdecl, nullHandler, lessThanSign, exclamationMark, capitalE, capitalL, capitalE, capitalM, capitalE, capitalN, capitalT, S, Name, S, contentspec, S, greaterThanSign);
		this.grammar.addProduction(elementdecl, nullHandler, lessThanSign, exclamationMark, capitalE, capitalL, capitalE, capitalM, capitalE, capitalN, capitalT, S, Name, S, contentspec, greaterThanSign);
	}
