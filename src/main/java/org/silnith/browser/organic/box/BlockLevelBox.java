...
/**
 * This represents a box element that can be layed out inside the
 * CSS box model.
 * 
 * @author kent
 */
public interface BlockLevelBox {
	 ...
	 * 
	 * <p>This will attempt to fit within {@code targetWidth}.  However, it is
	 * not guaranteed that the final rendering will always meet this requirement.
	 * Use {@link RenderableContent#getSize()} to get the true dimensions.
	 * 
	 * <p>Neither this object nor the returned object will maintain a reference
	 * to the {@link Graphics2D} object.  However, if the {@link Graphics2D} object
	 * later passed to {@link RenderableContent#paintComponent(java.awt.Point, java.awt.Graphics)}
	 ...
	 */
	RenderableContent layoutContents(AbsoluteLength containingBlockWidth, AbsoluteLength targetWidth, Graphics2D graphics);
