 ...
 * {@linkplain ElementProduction STag} {@linkplain ElementProduction content}
 * {@linkplain ElementProduction ETag} [40] STag ::= '&lt;'
 * {@linkplain NameProduction Name} ({@linkplain SProduction S}
 * {@linkplain AttributeProduction Attribute})* {@linkplain SProduction S}?
 * '&gt;' [42] ETag ::= '&lt;/' {@linkplain NameProduction Name}
 * {@linkplain SProduction S}? '&gt;' [43] content ::=
 ...
 * CharData}?)* [44] EmptyElemTag ::= '&lt;' {@linkplain NameProduction Name} (
 * {@linkplain SProduction S} {@linkplain AttributeProduction Attribute})*
 * {@linkplain SProduction S}? '/&gt;'
 * 
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-element">element
 *      </a>
 ...
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-content">content
 *      </a>
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-EmptyElemTag">
 *      EmptyElemTag</a>
...
public class ElementProduction extends XMLProduction {
    ...
    public ElementProduction(final Grammar<UnicodeTerminalSymbols> grammar, final NameProduction nameProduction,
            final SProduction sProduction, final AttributeProduction attributeProduction,
            final CharDataProduction charDataProduction, final ReferenceProduction referenceProduction,
            final CDSectProduction cdSectProduction, final PIProduction piProduction,
        ...
        this.grammar.addProduction(EmptyElemTag, emptyElemTagAttributesHandler, lessThanSign, Name, AttributeList_Plus,
                S, solidus, greaterThanSign);
        this.grammar.addProduction(EmptyElemTag, emptyElemTagAttributesHandler, lessThanSign, Name, AttributeList_Plus,
                solidus, greaterThanSign);
        ...
        this.grammar.addProduction(STag, sTagAttributesHandler, lessThanSign, Name, AttributeList_Plus, S,
                greaterThanSign);
        this.grammar.addProduction(STag, sTagAttributesHandler, lessThanSign, Name, AttributeList_Plus,
                greaterThanSign);
        ...
        this.grammar.addProduction(content_and_ETag, new AppendContentAndETagHandler(), CharData, content,
                content_and_ETag);
