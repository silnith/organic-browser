...
/**
 * [67]   	Reference	   ::=   	{@linkplain EntityRefProduction EntityRef} | {@linkplain CharRefProduction CharRef} 
 * 
...
public class ReferenceProduction extends XMLProduction {
	...
	public ReferenceProduction(final Grammar<UnicodeTerminalSymbols> grammar,
			final EntityRefProduction entityRefProduction,
			final CharRefProduction charRefProduction) {
		super(grammar);
