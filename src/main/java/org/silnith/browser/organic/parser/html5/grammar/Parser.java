...
public class Parser {
	...
	public enum Mode {
		/**
		 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#the-initial-insertion-mode">12.2.5.4.1 The "initial" insertion mode</a>
		 */
		INITIAL,
		/**
		 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#the-before-html-insertion-mode">12.2.5.4.2 The "before html" insertion mode</a>
		 */
		BEFORE_HTML,
		/**
		...
		BEFORE_HEAD,
		/**
		 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#parsing-main-inhead">12.2.5.4.4 The "in head" insertion mode</a>
		 */
		IN_HEAD,
		/**
		...
		AFTER_HEAD,
		/**
		 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#parsing-main-inbody">12.2.5.4.7 The "in body" insertion mode</a>
		 */
		IN_BODY,
		/**
		 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#parsing-main-incdata">12.2.5.4.8 The "text" insertion mode</a>
		 */
		TEXT,
		/**
		...
		IN_TABLE,
		/**
		 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#parsing-main-intabletext">12.2.5.4.10 The "in table text" insertion mode</a>
		 */
		IN_TABLE_TEXT,
		/**
		 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#parsing-main-incaption">12.2.5.4.11 The "in caption" insertion mode</a>
		 */
		IN_CAPTION,
		/**
		 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#parsing-main-incolgroup">12.2.5.4.12 The "in column group" insertion mode</a>
		 */
		IN_COLUMN_GROUP,
		/**
		...
		IN_TABLE_BODY,
		/**
		 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#parsing-main-intr">12.2.5.4.14 The "in row" insertion mode</a>
		 */
		IN_ROW,
		/**
		...
		IN_CELL,
		/**
		 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#parsing-main-inselect">12.2.5.4.16 The "in select" insertion mode</a>
		 */
		IN_SELECT,
		/**
		...
		IN_SELECT_IN_TABLE,
		/**
		 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#parsing-main-intemplate">12.2.5.4.18 The "in template" insertion mode</a>
		 */
		IN_TEMPLATE,
		/**
		...
		AFTER_BODY,
		/**
		 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#parsing-main-inframeset">12.2.5.4.20 The "in frameset" insertion mode</a>
		 */
		IN_FRAMESET,
		/**
		...
		AFTER_FRAMESET,
		/**
		 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#the-after-after-body-insertion-mode">12.2.5.4.22 The "after after body" insertion mode</a>
		 */
		AFTER_AFTER_BODY,
		/**
...
//	}
	 ...
	 * @param node
	 * @return
	 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#mathml-text-integration-point">MathML text integration point</a>
	 */
	 ...
	 * @param node
	 * @return
	 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#html-integration-point">HTML integration point</a>
	 */
	...
	/**
	 * @param token
	 * @see <a href="http://www.whatwg.org/specs/web-apps/current-work/multipage/tree-construction.html#tree-construction-dispatcher">tree construction dispatcher</a>
	 */
...
//		}
	...
	public static void main(final String[] args) throws UnsupportedEncodingException, IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, ClassCastException {
