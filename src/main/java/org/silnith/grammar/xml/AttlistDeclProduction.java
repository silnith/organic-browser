...
/**
 * [52]   	AttlistDecl	   ::=   	'&lt;!ATTLIST' {@linkplain SProduction S} {@linkplain NameProduction Name} {@linkplain AttDefProduction AttDef}* {@linkplain SProduction S}? '&gt;'
 * 
...
public class AttlistDeclProduction extends XMLProduction {
	...
	public AttlistDeclProduction(final Grammar<UnicodeTerminalSymbols> grammar,
		...
		this.grammar.addProduction(AttlistDecl, nullHandler, lessThanSign, exclamationMark, capitalA, capitalT, capitalT, capitalL, capitalI, capitalS, capitalT, S, Name, S, AttDef_Plus, greaterThanSign);
		this.grammar.addProduction(AttlistDecl, nullHandler, lessThanSign, exclamationMark, capitalA, capitalT, capitalT, capitalL, capitalI, capitalS, capitalT, S, Name, S, greaterThanSign);
		this.grammar.addProduction(AttlistDecl, nullHandler, lessThanSign, exclamationMark, capitalA, capitalT, capitalT, capitalL, capitalI, capitalS, capitalT, S, Name, greaterThanSign);
	}
