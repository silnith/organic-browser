...
/**
 * [28b]   	intSubset	   ::=   	({@linkplain MarkupDeclProduction markupdecl} | {@linkplain DeclSepProduction DeclSep})*
 * 
...
public class IntSubsetProduction extends XMLProduction {
	...
	public IntSubsetProduction(final Grammar<UnicodeTerminalSymbols> grammar,
