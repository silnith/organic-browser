...
public class WrappedLineBox extends LineBox {
    ...
    public WrappedLineBox(final List<RenderableLineContent> renderableLineContents, final boolean openAtStart,
            final boolean openAtEnd, final BackgroundInformation backgroundInformation,
            BorderInformation borderInformation, final ResolvedPaddingInformation resolvedPaddingInformation) {
        ...
        paddedSize.setSize(paddingLeft + contentSize.getWidth() + paddingRight,
                paddingTop + contentSize.getHeight() + paddingBottom);
