...
/**
 * [61] conditionalSect ::= {@linkplain IncludeSectProduction includeSect} |
...
public class ConditionalSectProduction extends XMLProduction {
    ...
    public ConditionalSectProduction(final Grammar<UnicodeTerminalSymbols> grammar,
            final IncludeSectProduction includeSectProduction, final IgnoreSectProduction ignoreSectProduction) {
        super(grammar);
