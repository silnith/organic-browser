...
/**
 * [28] doctypedecl ::= '&lt;!DOCTYPE' {@linkplain SProduction S}
 * {@linkplain NameProduction Name} ({@linkplain SProduction S}
 * {@linkplain ExternalIDProduction ExternalID})? {@linkplain SProduction S}?
 * ('[' {@linkplain IntSubsetProduction intSubset} ']' {@linkplain SProduction
 * S}?)? '&gt;'
 * 
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-doctypedecl">
 *      doctypedecl</a>
...
public class DoctypedeclProduction extends XMLProduction {
    ...
    private static class FullHandler implements ProductionHandler {
        ...
        public Object handleReduction(final List<Object> rightHandSide) {
            final DocTypeDecl docTypeDecl = new DocTypeDecl();
    ...
    public DoctypedeclProduction(final Grammar<UnicodeTerminalSymbols> grammar, final SProduction sProduction,
        ...
        this.grammar.addProduction(doctypedecl, fullHandler, lessThanSign, exclamationMark, capitalD, capitalO,
                capitalC, capitalT, capitalY, capitalP, capitalE, S, Name, S, ExternalID, S, leftBracket, intSubset,
                rightBracket, S, greaterThanSign);
        this.grammar.addProduction(doctypedecl, fullHandler, lessThanSign, exclamationMark, capitalD, capitalO,
                capitalC, capitalT, capitalY, capitalP, capitalE, S, Name, S, ExternalID, S, leftBracket, intSubset,
                rightBracket, greaterThanSign);
        this.grammar.addProduction(doctypedecl, fullHandler, lessThanSign, exclamationMark, capitalD, capitalO,
                capitalC, capitalT, capitalY, capitalP, capitalE, S, Name, S, ExternalID, S, greaterThanSign);
        this.grammar.addProduction(doctypedecl, fullHandler, lessThanSign, exclamationMark, capitalD, capitalO,
                capitalC, capitalT, capitalY, capitalP, capitalE, S, Name, S, ExternalID, leftBracket, intSubset,
                rightBracket, S, greaterThanSign);
        this.grammar.addProduction(doctypedecl, fullHandler, lessThanSign, exclamationMark, capitalD, capitalO,
                capitalC, capitalT, capitalY, capitalP, capitalE, S, Name, S, ExternalID, leftBracket, intSubset,
                rightBracket, greaterThanSign);
        this.grammar.addProduction(doctypedecl, fullHandler, lessThanSign, exclamationMark, capitalD, capitalO,
                capitalC, capitalT, capitalY, capitalP, capitalE, S, Name, S, ExternalID, greaterThanSign);
        this.grammar.addProduction(doctypedecl, fullHandler, lessThanSign, exclamationMark, capitalD, capitalO,
                capitalC, capitalT, capitalY, capitalP, capitalE, S, Name, S, leftBracket, intSubset, rightBracket, S,
                greaterThanSign);
        this.grammar.addProduction(doctypedecl, fullHandler, lessThanSign, exclamationMark, capitalD, capitalO,
                capitalC, capitalT, capitalY, capitalP, capitalE, S, Name, S, leftBracket, intSubset, rightBracket,
                greaterThanSign);
        this.grammar.addProduction(doctypedecl, fullHandler, lessThanSign, exclamationMark, capitalD, capitalO,
                capitalC, capitalT, capitalY, capitalP, capitalE, S, Name, S, greaterThanSign);
        this.grammar.addProduction(doctypedecl, fullHandler, lessThanSign, exclamationMark, capitalD, capitalO,
                capitalC, capitalT, capitalY, capitalP, capitalE, S, Name, leftBracket, intSubset, rightBracket, S,
                greaterThanSign);
        this.grammar.addProduction(doctypedecl, fullHandler, lessThanSign, exclamationMark, capitalD, capitalO,
                capitalC, capitalT, capitalY, capitalP, capitalE, S, Name, leftBracket, intSubset, rightBracket,
                greaterThanSign);
        this.grammar.addProduction(doctypedecl, fullHandler, lessThanSign, exclamationMark, capitalD, capitalO,
                capitalC, capitalT, capitalY, capitalP, capitalE, S, Name, greaterThanSign);
    }
