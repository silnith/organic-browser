...
public class SystemLiteralProduction extends XMLProduction {
	...
	public SystemLiteralProduction(final Grammar<UnicodeTerminalSymbols> grammar) {
		...
		final NonTerminalSymbol SystemLiteral_inner_quot_Plus = this.grammar.getNonTerminalSymbol("SystemLiteral-inner-quot-Plus");
		final NonTerminalSymbol SystemLiteral_inner_apos_Plus = this.grammar.getNonTerminalSymbol("SystemLiteral-inner-apos-Plus");
		...
		this.grammar.addProduction(SystemLiteral, secondElementHandler, quotationMark, SystemLiteral_inner_quot_Plus, quotationMark);
		this.grammar.addProduction(SystemLiteral, emptyStringHandler, quotationMark, quotationMark);
		this.grammar.addProduction(SystemLiteral, secondElementHandler, apostrophe, SystemLiteral_inner_apos_Plus, apostrophe);
		this.grammar.addProduction(SystemLiteral, emptyStringHandler, apostrophe, apostrophe);
		
		this.grammar.addProduction(SystemLiteral_inner_quot_Plus, stringHandler, SystemLiteral_inner_quot_Plus, SystemLiteral_Char);
		this.grammar.addProduction(SystemLiteral_inner_quot_Plus, stringHandler, SystemLiteral_inner_quot_Plus, apostrophe);
		...
		this.grammar.addProduction(SystemLiteral_inner_apos_Plus, stringHandler, SystemLiteral_inner_apos_Plus, SystemLiteral_Char);
		this.grammar.addProduction(SystemLiteral_inner_apos_Plus, stringHandler, SystemLiteral_inner_apos_Plus, quotationMark);
