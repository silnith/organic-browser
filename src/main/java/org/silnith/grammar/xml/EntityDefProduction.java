...
/**
 * [73] EntityDef ::= {@linkplain EntityValueProduction EntityValue} | (
...
public class EntityDefProduction extends XMLProduction {
    ...
    public EntityDefProduction(final Grammar<UnicodeTerminalSymbols> grammar,
            final EntityValueProduction entityValueProduction, final ExternalIDProduction externalIDProduction,
