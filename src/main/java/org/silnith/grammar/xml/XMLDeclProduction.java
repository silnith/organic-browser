...
/**
 * [23] XMLDecl ::= '&lt;?xml' {@linkplain VersionInfoProduction VersionInfo}
 * {@linkplain EncodingDeclProduction EncodingDecl}?
 * {@linkplain SDDeclProduction SDDecl}? {@linkplain SProduction S}? '?&gt;'
 * 
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-XMLDecl">XMLDecl
 *      </a>
...
public class XMLDeclProduction extends XMLProduction {
    ...
    public XMLDeclProduction(final Grammar<UnicodeTerminalSymbols> grammar,
            final VersionInfoProduction versionInfoProduction, final EncodingDeclProduction encodingDeclProduction,
            final SDDeclProduction sdDeclProduction, final SProduction sProduction) {
        super(grammar);
        ...
        this.grammar.addProduction(XMLDecl, nullHandler, lessThanSign, questionMark, smallX, smallM, smallL,
                VersionInfo, EncodingDecl, SDDecl, S, questionMark, greaterThanSign);
        this.grammar.addProduction(XMLDecl, nullHandler, lessThanSign, questionMark, smallX, smallM, smallL,
                VersionInfo, SDDecl, S, questionMark, greaterThanSign);
        this.grammar.addProduction(XMLDecl, nullHandler, lessThanSign, questionMark, smallX, smallM, smallL,
                VersionInfo, EncodingDecl, S, questionMark, greaterThanSign);
        this.grammar.addProduction(XMLDecl, nullHandler, lessThanSign, questionMark, smallX, smallM, smallL,
                VersionInfo, S, questionMark, greaterThanSign);
        this.grammar.addProduction(XMLDecl, nullHandler, lessThanSign, questionMark, smallX, smallM, smallL,
                VersionInfo, EncodingDecl, SDDecl, questionMark, greaterThanSign);
        this.grammar.addProduction(XMLDecl, nullHandler, lessThanSign, questionMark, smallX, smallM, smallL,
                VersionInfo, SDDecl, questionMark, greaterThanSign);
        this.grammar.addProduction(XMLDecl, nullHandler, lessThanSign, questionMark, smallX, smallM, smallL,
                VersionInfo, EncodingDecl, questionMark, greaterThanSign);
        this.grammar.addProduction(XMLDecl, nullHandler, lessThanSign, questionMark, smallX, smallM, smallL,
                VersionInfo, questionMark, greaterThanSign);
    }
