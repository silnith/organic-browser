...
public class BackgroundInformation {
	...
	private static final PropertyAccessor<Color> backgroundColorAccessor = (PropertyAccessor<Color>) propertyAccessorFactory.getPropertyAccessor(PropertyName.BACKGROUND_COLOR);
