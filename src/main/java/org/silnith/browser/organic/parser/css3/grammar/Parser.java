...
/**
 * @see <a href="http://dev.w3.org/csswg/css-syntax/#parser-entry-points">5.3 Parser Entry Points</a>
...
public class Parser {
	...
	/**
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#current-input-token">current input token</a>
	 */
	private Token currentInputToken;

	/**
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#next-input-token">next input token</a>
	 */
	...
	/**
	 * @throws IOException
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#consume-the-next-input-token">consume the next input token</a>
	 */
	 ...
	 * @return
	 * @throws IOException
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#parse-a-stylesheet">5.3.1 Parse a stylesheet</a>
	 */
	 ...
	 * It differs from "Parse a stylesheet" in the handling of <CDO-token> and <CDC-token>.
	 * 
	 * @throws IOException
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#parse-a-list-of-rules">5.3.2 Parse a list of rules</a>
	 */
	...
	/**
	 * "Parse a rule" is intended for use by the {@link CSSStyleSheet#insertRule method},
	 * and similar functions which might exist, which parse text into a single rule.
	 * 
	 * @return
	 * @throws IOException
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#parse-a-rule">5.3.3 Parse a rule</a>
	 */
	 ...
	 * @return
	 * @throws IOException
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#parse-a-declaration">5.3.4 Parse a declaration</a>
	 */
	...
	/**
	 * "Parse a component value" is for things that need to consume a single value,
	 ...
	 * parsing a stand-alone selector [SELECT] or list of Media Queries [MEDIAQ],
	...
	public List<Token> parseListOfComponentValues() throws IOException {
		...
		} while (value.getType() != Token.Type.EOF_TOKEN
				&& !isLexicalToken(value, LexicalToken.LexicalType.EOF));
	 ...
	 * @return
	 * @throws IOException
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#consume-a-list-of-rules">5.4.1 Consume a list of rules</a>
	 */
	 ...
	 * @return
	 * @throws IOException
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#consume-an-at-rule">5.4.2 Consume an at-rule</a>
	 */
	 ...
	 * @return
	 * @throws IOException
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#consume-a-qualified-rule">5.4.3 Consume a qualified rule</a>
	 */
	 ...
	 * @return
	 * @throws IOException
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#consume-a-list-of-declarations">5.4.4 Consume a list of declarations</a>
	 */
	 ...
	 * @return
	 * @throws IOException
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#consume-a-declaration">5.4.5 Consume a declaration</a>
	 */
	 ...
	 * @return
	 * @throws IOException
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#consume-a-component-value">5.4.6 Consume a component value</a>
	 */
	 ...
	 * @return
	 * @throws IOException
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#consume-a-simple-block">5.4.7 Consume a simple block</a>
	 */
	 ...
	 * @return
	 * @throws IOException
	 * @see <a href="http://dev.w3.org/csswg/css-syntax/#consume-a-function">5.4.8 Consume a function</a>
	 */
