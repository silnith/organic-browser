...
/**
 * [78] extParsedEnt ::= {@linkplain TextDeclProduction TextDecl}?
 * {@linkplain ElementProduction content}
 * 
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-extParsedEnt">
 *      extParsedEnt</a>
...
public class ExtParsedEntProduction extends XMLProduction {
    ...
    public ExtParsedEntProduction(final Grammar<UnicodeTerminalSymbols> grammar,
            final TextDeclProduction textDeclProduction, final ElementProduction elementProduction) {
        super(grammar);
