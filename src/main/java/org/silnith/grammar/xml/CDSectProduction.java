...
/**
 * [18] CDSect ::= {@linkplain CDSectProduction CDStart}
 * {@linkplain CDSectProduction CData} {@linkplain CDSectProduction CDEnd} [19]
 * CDStart ::= '&lt;![CDATA[' [20] CData ::= ({@linkplain CharProduction Char}*
 * - ({@linkplain CharProduction Char}* ']]&gt;' {@linkplain CharProduction
 * Char}*)) [21] CDEnd ::= ']]&gt;'
 * 
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-CDSect">CDSect
 *      </a>
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-CDStart">CDStart
 *      </a>
...
public class CDSectProduction extends XMLProduction {
    ...
    public CDSectProduction(final Grammar<UnicodeTerminalSymbols> grammar) {
        ...
        this.grammar.addProduction(CDStart, nullHandler, lessThanSign, exclamationMark, leftBracket, capitalC, capitalD,
                capitalA, capitalT, capitalA, leftBracket);
        ...
        this.grammar.addProduction(CData_body, penultimateRightBracketHandler, CData_body_inner, rightBracket,
                CData_body_suffix_Plus);
                
        this.grammar.addProduction(CData_body_suffix_Plus, endingRightBracketHandler, CData_body_suffix_Plus,
                CData_Char, CData_body_inner, rightBracket);
        this.grammar.addProduction(CData_body_suffix_Plus, endingRightBracketHandler, CData_Char, CData_body_inner,
                rightBracket);
                
        this.grammar.addProduction(CData_body_inner, penultimateRightBracketHandler, CData_Char_Plus, rightBracket,
                CData_body_inner_Plus);
        ...
        this.grammar.addProduction(CData_body_inner_Plus, endingRightBracketHandler, CData_body_inner_Plus,
                CData_Char_Plus, rightBracket);
