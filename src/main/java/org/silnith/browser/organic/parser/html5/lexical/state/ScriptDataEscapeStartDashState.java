...
/**
 * @see <a href=
 *      "http://www.whatwg.org/specs/web-apps/current-work/multipage/tokenization.html#script-data-escape-start-dash-state">
 *      12.2.4.21 Script data escape start dash state</a>
