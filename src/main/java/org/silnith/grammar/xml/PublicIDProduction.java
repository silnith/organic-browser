...
/**
 * [83] PublicID ::= 'PUBLIC' {@linkplain SProduction S}
 * {@linkplain PubidLiteralProduction PubidLiteral}
 * 
...
public class PublicIDProduction extends XMLProduction {
    ...
    public PublicIDProduction(final Grammar<UnicodeTerminalSymbols> grammar, final SProduction sProduction,
        ...
        this.grammar.addProduction(PublicID, nullHandler, capitalP, capitalU, capitalB, capitalL, capitalI, capitalC, S,
                PubidLiteral);
    }
