...
public class CSSNumberParser {
	...
	/**
	 * Numbers in CSS can either be integers or floating-point values.
	 * If they are integers, they are a string of one or more digits with an
	 * optional preceeding sign.
	 * If they are floating-point values, they are a string of zero or more
	 * digits, a dot, and a string of one or more digits, all with an
	 * optional preceeding sign.
	 */
	 ...
	 * @return a CSS number
	 * @see {@linkplain http://www.w3.org/TR/CSS2/syndata.html#value-def-length}
	 */
