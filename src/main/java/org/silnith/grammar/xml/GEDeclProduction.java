...
/**
 * [71] GEDecl ::= '&lt;!ENTITY' {@linkplain SProduction S}
 * {@linkplain NameProduction Name} {@linkplain SProduction S}
 * {@linkplain EntityDefProduction EntityDef} {@linkplain SProduction S}? '&gt;'
 * 
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-GEDecl">GEDecl
 *      </a>
...
public class GEDeclProduction extends XMLProduction {
    ...
    public GEDeclProduction(final Grammar<UnicodeTerminalSymbols> grammar, final SProduction sProduction,
            final NameProduction nameProduction, final EntityDefProduction entityDefProduction) {
        super(grammar);
        ...
        this.grammar.addProduction(GEDecl, nullHandler, lessThanSign, exclamationMark, capitalE, capitalN, capitalT,
                capitalI, capitalT, capitalY, S, Name, S, EntityDef, greaterThanSign);
    }
