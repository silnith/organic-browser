 ...
 * <blockquote>
 * {@code <p>Some <em>emphasized</em> text</p>}
 * </blockquote>
 * the {@code <p>} generates a block box, with several inline boxes inside it. The box for "emphasized" is an inline box generated by an inline element ({@code <em>}), but the other boxes ("Some" and "text") are inline boxes generated by a block-level element ({@code <p>}). The latter are called anonymous inline boxes, because they do not have an associated inline-level element.
 * <p>
 ...
 * 
 * @author kent
 * @see <a href="https://www.w3.org/TR/CSS2/visuren.html#anonymous">9.2.2.1 Anonymous inline boxes</a>
 */
    ...
    private class RenderableText implements RenderableLineContent {
        ...
        public boolean containsPoint(Point2D startPoint, Point2D clickPoint) {
            ...
            if (contains) {
                ...
                final TextHitInfo hitTestChar = textLayout.hitTestChar((float) (startPoint.getX() + clickPoint.getX()),
                        (float) (startPoint.getY() + clickPoint.getY()));
                System.out.println(hitTestChar);
            }
            return contains;
        }
...
//			box.paintComponent(startPoint, graphics);
        ...
        public String toString() {
            return "RenderableText [textLayout=" + textLayout + ", baseline=" + baseline + ", size=" + size + "]";
        }
    ...
    public AnonymousInlineBox(
        ...
        this.color = colorAccessor.getComputedValue(styledText.getStyleData());
