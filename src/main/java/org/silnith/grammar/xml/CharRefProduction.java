 ...
 * 
 * @see <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#NT-CharRef">CharRef
 *      </a>
...
public class CharRefProduction extends XMLProduction {
    ...
    public CharRefProduction(final Grammar<UnicodeTerminalSymbols> grammar,
        ...
        this.grammar.addProduction(CharRef, new DecimalReferenceHandler(), ampersand, numberSign, DECIMAL_DIGIT_Plus,
                semicolon);
        this.grammar.addProduction(CharRef, new HexadecimalReferenceHandler(), ampersand, numberSign, smallX,
                HEX_DIGIT_Plus, semicolon);
        ...
        for (final UnicodeTerminalSymbols s : Arrays.asList(digitZero, digitOne, digitTwo, digitThree, digitFour,
                digitFive, digitSix, digitSeven, digitEight, digitNine, capitalA, capitalB, capitalC, capitalD,
                capitalE, capitalF, smallA, smallB, smallC, smallD, smallE, smallF)) {
