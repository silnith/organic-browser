...
/**
 * @see <a href=
 *      "http://www.whatwg.org/specs/web-apps/current-work/multipage/tokenization.html#script-data-escaped-end-tag-open-state">
 *      12.2.4.26 Script data escaped end tag open state</a>
