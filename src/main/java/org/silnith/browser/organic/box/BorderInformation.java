...
public class BorderInformation {
	...
	private static final PropertyAccessor<BorderStyle> borderTopStyleAccessor = (PropertyAccessor<BorderStyle>) propertyAccessorFactory.getPropertyAccessor(PropertyName.BORDER_TOP_STYLE);
	private static final PropertyAccessor<BorderStyle> borderRightStyleAccessor = (PropertyAccessor<BorderStyle>) propertyAccessorFactory.getPropertyAccessor(PropertyName.BORDER_RIGHT_STYLE);
	private static final PropertyAccessor<BorderStyle> borderBottomStyleAccessor = (PropertyAccessor<BorderStyle>) propertyAccessorFactory.getPropertyAccessor(PropertyName.BORDER_BOTTOM_STYLE);
	private static final PropertyAccessor<BorderStyle> borderLeftStyleAccessor = (PropertyAccessor<BorderStyle>) propertyAccessorFactory.getPropertyAccessor(PropertyName.BORDER_LEFT_STYLE);

	private static final PropertyAccessor<Color> borderTopColorAccessor = (PropertyAccessor<Color>) propertyAccessorFactory.getPropertyAccessor(PropertyName.BORDER_TOP_COLOR);
	private static final PropertyAccessor<Color> borderRightColorAccessor = (PropertyAccessor<Color>) propertyAccessorFactory.getPropertyAccessor(PropertyName.BORDER_RIGHT_COLOR);
	private static final PropertyAccessor<Color> borderBottomColorAccessor = (PropertyAccessor<Color>) propertyAccessorFactory.getPropertyAccessor(PropertyName.BORDER_BOTTOM_COLOR);
	private static final PropertyAccessor<Color> borderLeftColorAccessor = (PropertyAccessor<Color>) propertyAccessorFactory.getPropertyAccessor(PropertyName.BORDER_LEFT_COLOR);

	private static final PropertyAccessor<AbsoluteLength> borderTopWidthAccessor = (PropertyAccessor<AbsoluteLength>) propertyAccessorFactory.getPropertyAccessor(PropertyName.BORDER_TOP_WIDTH);
	private static final PropertyAccessor<AbsoluteLength> borderRightWidthAccessor = (PropertyAccessor<AbsoluteLength>) propertyAccessorFactory.getPropertyAccessor(PropertyName.BORDER_RIGHT_WIDTH);
	private static final PropertyAccessor<AbsoluteLength> borderBottomWidthAccessor = (PropertyAccessor<AbsoluteLength>) propertyAccessorFactory.getPropertyAccessor(PropertyName.BORDER_BOTTOM_WIDTH);
	private static final PropertyAccessor<AbsoluteLength> borderLeftWidthAccessor = (PropertyAccessor<AbsoluteLength>) propertyAccessorFactory.getPropertyAccessor(PropertyName.BORDER_LEFT_WIDTH);

	@Deprecated
	public static BorderInformation getBorderInformation(
			final StyledContent styledContent) {
	...
	public BorderInformation(final BorderStyle borderTopStyle,
			...
			final AbsoluteLength borderTopWidth,
			final AbsoluteLength borderRightWidth,
			final AbsoluteLength borderBottomWidth,
			final AbsoluteLength borderLeftWidth) {
		super();
	...
	public AbsoluteLength getBorderTopWidth() {
		if (borderTopStyle == BorderStyle.NONE
				|| borderTopStyle == BorderStyle.HIDDEN) {
	...
	public AbsoluteLength getBorderRightWidth() {
		if (borderRightStyle == BorderStyle.NONE
				|| borderRightStyle == BorderStyle.HIDDEN) {
			return AbsoluteLength.ZERO;
		} else {
	...
	public AbsoluteLength getBorderLeftWidth() {
		if (borderLeftStyle == BorderStyle.NONE
				|| borderLeftStyle == BorderStyle.HIDDEN) {
			return AbsoluteLength.ZERO;
		} else {
